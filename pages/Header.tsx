      ...
      <header className='fixed top-0 left-0 w-full backdrop-blur-lg z-50 p-4'>
        <nav className='container mx-auto px-6 py-4 flex justify-between items-center'>
          ...
          <div className='flex-shrink-0'>
            ...
            <div 
    className="absolute top-1/2 left-1/2 -z-10 h-96 w-96 -translate-x-1/2 -translate-y-1/2 rounded-full bg-cyan-600/20 blur-[120px]"
  ></div>
        ...
        <div className='flex flex-col items-center justify-center h-full'>
          <ul className='space-y-5 text-center text-[#7c859f] font-semibold text-xl'>
            <li onClick={() => setIsOpen(false)}>
              <Link href="/app"><div className=" ">App</div></Link>
            </li>
            <li onClick={() => setIsOpen(false)}>
              <Link href="/products"><div className=" ">Products</div></Link>
            </li>
            <li onClick={() => setIsOpen(false)}>
              <Link href="/build"><div className=" ">Build</div></Link>
            </li>
            <li onClick={() => setIsOpen(false)}>
              <Link href="/careers"><div className="">Careers</div></Link>
            </li>
            <li onClick={() => setIsOpen(false)}>
